...
@Component({
  ...
  templateUrl: './vastushastra.html',
  styleUrl: './vastushastra.css'
})
export class Vastushastra {

  svgColor!: ISvgColors;

  pageHeading = "Vastushastra";

  vastushastraContent: IArticle = {
    title: "",
